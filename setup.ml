...
(* OASIS_START *)
(* DO NOT EDIT (digest: 435801263b7181349ad01463ad0190f5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "https://github.com/mwweissmann/ocaml-posix-syslog/";
          bugreports = None;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for posix-syslog";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "posix-syslog"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest =
       Some "m\182\b\222\004~\175\129\219\021\192\025\232\249\030\n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
