(* OASIS_START *)
(* DO NOT EDIT (digest: 23549a79e59e0e967f02635b47997d8a) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("posix-syslog", ["src"], [])];
     lib_c = [("posix-syslog", "src", [])];
     flags =
       [
          (["oasis_library_posix_syslog_ccopt"; "compile"],
            [
